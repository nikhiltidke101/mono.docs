...
methods:
  ...
  - type: POST
    title: Get Post
    slug: artifacts-get-post
  - type: GET
    title: List
    slug: artifacts-list
  - type: POST
    title: List Post
    slug: artifacts-list-post
  - type: GET
    title: Locate
    slug: artifacts-locate
  - type: POST
    title: Locate Post
    slug: artifacts-locate-post
  - type: POST
    title: Prepare
...
<APIInfo method={"GET"} route={"/artifacts.get"}>
...
```bash title="curl"
curl -X GET "https://api.devrev.ai/artifacts.get"
```
...
<APIInfo method={"POST"} route={"/artifacts.get"}>
...
<APIInfo method={"GET"} route={"/artifacts.list"}>
...
<Property required={false} deprecated={false} name={"parent_id"} type={"string"}>
...
```bash title="curl"
curl -X GET "https://api.devrev.ai/artifacts.list"
```
...
<APIInfo method={"POST"} route={"/artifacts.list"}>
...
<APIInfo method={"GET"} route={"/artifacts.locate"}>
...
```bash title="curl"
curl -X GET "https://api.devrev.ai/artifacts.locate"
```
...
<APIInfo method={"POST"} route={"/artifacts.locate"}>

## artifacts-locate-post
