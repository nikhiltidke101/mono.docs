...
methods:
  ...
  - type: POST
    title: Timeline Entries Delete
    slug: timeline-entries-delete
  - type: GET
    title: Timeline Entries Get
    slug: timeline-entries-get
  - type: POST
    title: Timeline Entries Get Post
    slug: timeline-entries-get-post
  - type: GET
