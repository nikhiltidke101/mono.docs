...
methods:
  - type: GET
    ...
    slug: dev-users-get
  - type: POST
    title: Dev Users Get Post
    slug: dev-users-get-post
  - type: GET
    title: Dev Users List
    slug: dev-users-list
  - type: POST
    title: Dev Users List Post
    slug: dev-users-list-post
  - type: GET
    title: Dev Users Self
    slug: dev-users-self
  - type: POST
    title: Dev Users Self Post
    slug: dev-users-self-post
toc: false
---
