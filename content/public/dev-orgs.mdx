...
methods:
  - type: POST
    title: Dev Org Auth Connections Create
    slug: dev-org-auth-connections-create
  - type: POST
    title: Dev Org Auth Connections Delete
    slug: dev-org-auth-connections-delete
  - type: GET
    title: Dev Org Auth Connections Get
    slug: dev-org-auth-connections-get
  - type: POST
    title: Dev Org Auth Connections Get Post
    slug: dev-org-auth-connections-get-post
  - type: GET
    title: Dev Org Auth Connections List
    slug: dev-org-auth-connections-list
  - type: POST
    title: Dev Org Auth Connections List Post
    slug: dev-org-auth-connections-list-post
  - type: POST
    title: Dev Org Auth Connections Toggle
    slug: dev-org-auth-connections-toggle
  - type: POST
    title: Dev Org Auth Connections Update
    slug: dev-org-auth-connections-update
toc: false
---
