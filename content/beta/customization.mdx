...
methods:
  - type: GET
    title: Aggregated Schema Get
    slug: aggregated-schema-get
  - type: POST
    title: Aggregated Schema Get Post
    slug: aggregated-schema-get-post
  - type: GET
    title: Custom Schema Fragments Get
    slug: custom-schema-fragments-get
  - type: POST
    title: Custom Schema Fragments Get Post
    slug: custom-schema-fragments-get-post
  - type: GET
    title: Custom Schema Fragments List
    slug: custom-schema-fragments-list
  - type: POST
    title: Custom Schema Fragments List Post
    slug: custom-schema-fragments-list-post
  - type: POST
    title: Custom Schema Fragments Set
    slug: custom-schema-fragments-set
  - type: GET
    title: Stock Schema Fragments Get
    slug: stock-schema-fragments-get
  - type: POST
    title: Stock Schema Fragments Get Post
    slug: stock-schema-fragments-get-post
  - type: GET
    title: Stock Schema Fragments List
    slug: stock-schema-fragments-list
  - type: POST
    title: Stock Schema Fragments List Post
    slug: stock-schema-fragments-list-post
  - type: GET
    title: Subtypes List
    slug: subtypes-list
  - type: POST
    title: Subtypes List Post
    slug: subtypes-list-post
  - type: POST
    title: Custom Stages Create
    slug: custom-stages-create
  - type: GET
    title: Custom Stages Get
    slug: custom-stages-get
  - type: POST
    title: Custom Stages Get Post
    slug: custom-stages-get-post
  - type: GET
    title: Custom Stages List
    slug: custom-stages-list
  - type: POST
    title: Custom Stages List Post
    slug: custom-stages-list-post
  - type: POST
    title: Custom Stages Update
    slug: custom-stages-update
  - type: POST
    title: Custom States Create
    slug: custom-states-create
  - type: GET
    title: Custom States Get
    slug: custom-states-get
  - type: POST
    title: Custom States Get Post
    slug: custom-states-get-post
  - type: GET
    title: Custom States List
    slug: custom-states-list
  - type: POST
    title: Custom States List Post
    slug: custom-states-list-post
  - type: POST
    title: Custom States Update
    slug: custom-states-update
toc: false
---
