...
methods:
  - type: POST
    title: Code Changes Create
    slug: code-changes-create
  - type: POST
    title: Code Changes Delete
    slug: code-changes-delete
  - type: GET
    title: Code Changes Get
    slug: code-changes-get
  - type: POST
    title: Code Changes Get Post
    slug: code-changes-get-post
  - type: GET
    title: Code Changes List
    slug: code-changes-list
  - type: POST
    title: Code Changes List Post
    slug: code-changes-list-post
  - type: POST
    title: Code Changes Update
    slug: code-changes-update
toc: false
---
