...
methods:
  - type: POST
    title: Create
    slug: conversations-create
  - type: POST
    title: Delete
    slug: conversations-delete
  - type: GET
    title: Export
    slug: conversations-export
  - type: POST
    title: Export Post
    slug: conversations-export-post
  - type: GET
    title: Get
    slug: conversations-get
  - type: POST
    title: Get Post
    slug: conversations-get-post
  - type: GET
    title: List
    slug: conversations-list
  - type: POST
    title: List Post
    slug: conversations-list-post
  - type: POST
    title: Update
    slug: conversations-update
toc: false
---
