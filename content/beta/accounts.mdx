...
methods:
  ...
  - type: GET
    title: Export
    slug: accounts-export
  - type: POST
    title: Export Post
    slug: accounts-export-post
  - type: GET
    title: Get
    slug: accounts-get
  - type: POST
    title: Get Post
    slug: accounts-get-post
  - type: GET
    title: List
    slug: accounts-list
  - type: POST
    title: List Post
    slug: accounts-list-post
  - type: POST
    title: Update
    slug: accounts-update
toc: false
---
...
<Property required={false} deprecated={false} name={"schema_fragment_ids"} type={"array of string"}>
