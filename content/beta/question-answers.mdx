...
methods:
  - type: POST
    ...
    slug: create-question-answer
  - type: POST
    title: Delete Question Answer
    slug: delete-question-answer
  - type: GET
    title: Get Question Answer
    slug: get-question-answer
  - type: POST
    title: Get Question Answer Post
    slug: get-question-answer-post
  - type: GET
    title: List Question Answers
    slug: list-question-answers
  - type: POST
    title: List Question Answers Post
    slug: list-question-answers-post
  - type: POST
    title: Update Question Answer
    slug: update-question-answer
toc: false
---
