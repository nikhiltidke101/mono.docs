...
methods:
  - type: POST
    title: Rev Users Create
    slug: rev-users-create
  - type: POST
    title: Rev Users Delete
    slug: rev-users-delete
  - type: GET
    title: Rev Users Get
    slug: rev-users-get
  - type: POST
    title: Rev Users Get Post
    slug: rev-users-get-post
  - type: POST
    title: Link Rev User To Rev Org
    slug: link-rev-user-to-rev-org
  - type: GET
    title: Rev Users List
    slug: rev-users-list
  - type: POST
    title: Rev Users List Post
    slug: rev-users-list-post
  - type: POST
    title: Unlink Rev User From Rev Org
    slug: unlink-rev-user-from-rev-org
  - type: POST
    title: Rev Users Update
    slug: rev-users-update
toc: false
---
