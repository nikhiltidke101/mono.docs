...
methods:
  - type: POST
    title: Org Schedule Fragments Create
    slug: org-schedule-fragments-create
  - type: GET
    title: Org Schedule Fragments Get
    slug: org-schedule-fragments-get
  - type: POST
    title: Org Schedule Fragments Get Post
    slug: org-schedule-fragments-get-post
  - type: POST
    title: Org Schedule Fragments Transition
    slug: org-schedule-fragments-transition
  - type: POST
    title: Org Create
    slug: org-schedules-create
  - type: GET
    title: Org Get
    slug: org-schedules-get
  - type: POST
    title: Org Get Post
    slug: org-schedules-get-post
  - type: GET
    title: Org List
    slug: org-schedules-list
  - type: POST
    title: Org List Post
    slug: org-schedules-list-post
  - type: POST
    title: Org Set Future
    slug: org-schedules-set-future
  - type: POST
    title: Org Transition
    slug: org-schedules-transition
  - type: POST
    title: Org Update
    slug: org-schedules-update
toc: false
---
