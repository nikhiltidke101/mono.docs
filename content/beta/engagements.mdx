...
methods:
  - type: GET
    title: Count
    slug: engagements-count
  - type: POST
    title: Count Post
    slug: engagements-count-post
  - type: POST
    title: Create
    slug: engagements-create
  - type: POST
    title: Delete
    slug: engagements-delete
  - type: GET
    title: Get
    slug: engagements-get
  - type: POST
    title: Get Post
    slug: engagements-get-post
  - type: GET
    title: List
    slug: engagements-list
  - type: POST
    title: List Post
    slug: engagements-list-post
  - type: POST
    title: Update
    slug: engagements-update
toc: false
---
